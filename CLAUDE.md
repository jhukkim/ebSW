...
| `bench/overhead/` | S1 4단(+E) 하네스 — 1차 실행됨, 결함 3건 수정 후 재실행 대기 |
| `bench/bypass/` | S2 §04 표 = bats 13케이스 + §18 4구멍(skip). **서브 PC 실행 미확인** |
...
| S2 ← 착수 | 태그 두 겹 — cgroup + fork 전파, §04 표 = bats | 앞 3줄(6건) 초록, 뒤 4줄 '끊김'이 확인됨 | **제품을 다시 정의한다** |
